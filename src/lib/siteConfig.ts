export const SITE = {
  ...
  phone: '+254728822142',           // E.164 — for tel: href and JSON-LD
  phoneDisplay: '+254 728 822 142', // for visible text
  waNumber: '254728822142',
  waMessage: "Hi Brian! I visited your website and I'd like to get in touch.",
  mapsUrl: 'https://maps.google.com/?q=Nakuru,Kenya',
  twitterHandle: '@bryanaim00',
}
...
export const SOCIALS = [
  ...
  { icon: 'fa-brands fa-x-twitter', label: 'X (Twitter)', sub: '@bryanaim00', url: 'https://x.com/bryanaim00', color: '#e7e7e7' },
